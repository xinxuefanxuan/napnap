...
public class NewReply {
    ...
    public NewReply(Long messageId, Long id, String userName, String userAccount, String userAvatar, Long fansNum, Long focusNum, String userProfile, Long postId, String postTitle, Date createTime, Long commentId, String commentContent, Long commentParentId, String commentParentContent) {

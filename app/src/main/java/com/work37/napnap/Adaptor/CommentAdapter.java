...
//                        commentAndUserList.add(newComment);
                        ...
                        if(commentAndUserList==null){
                            commentAndUserList = new ArrayList<>();
                        }
...
//                            List<CommentAndUser> newlist = new ArrayList<>();
                            RepliesAdapter newRepliesAdapter = new RepliesAdapter(commentAndUserList, context);
                            repliesRecyclerView.setLayoutManager(new LinearLayoutManager(context));
                            repliesRecyclerView.setAdapter(newRepliesAdapter);
                            newRepliesAdapter.addReply(newComment);
                        }
